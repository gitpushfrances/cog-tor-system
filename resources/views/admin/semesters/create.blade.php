<x-app-layout>
    <x-slot name="header">
        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Semester</h2>
    </x-slot>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="1st" {{ old('name') == '1st' ? 'selected' : '' }}>1st Semester</option>
                            <option value="2nd" {{ old('name') == '2nd' ? 'selected' : '' }}>2nd Semester</option>
