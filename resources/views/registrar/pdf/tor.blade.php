...
<head>
    ...
    <style>
        ...
        .semester-title { font-weight: bold; background: #e8e8e8; padding: 6px 8px; margin-top: 14px; border: 1px solid #000; }
        table.grades { width: 100%; border-collapse: collapse; margin-top: 0; }
...
<body>
    ...
    @foreach($allGradesData as $semesterData)
    <div class="semester-title">{{ $semesterData['semester'] }}</div>
    <table class="grades">
        <thead>
            <tr>
                <th>Subject Code</th>
        ...
        <tbody>
            @foreach($semesterData['subjects'] as $row)
            <tr>
    ...
    <div class="footer">
        <p>This is to certify that the above is a true and complete record of grades of the student named herein.</p>
