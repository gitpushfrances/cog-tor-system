<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Add Student</h2>
                <p class="mt-1 text-sm text-gray-500">Register a new student in your department</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white rounded-lg shadow">
                ...
                <form action="{{ route('head_of_department.students.store') }}" method="POST" class="p-6 space-y-5">
                    @csrf
